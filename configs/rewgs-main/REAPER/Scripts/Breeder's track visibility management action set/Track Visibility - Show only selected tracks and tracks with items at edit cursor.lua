...
-- Main ----------------------------------------------------------------------------------------------------------------
function Main ()
	visTools.ShowTracksHideOthers("Track Visibility - Show only selected tracks and tracks with items at edit cursor", true, true, true, false, false, false, false, true, false)
end
