...
-- Main ----------------------------------------------------------------------------------------------------------------
function Main ()
	visTools.ShowTracksHideOthers("Track Visibility - Show only selected tracks and tracks with selected items in time selection", true, true, true, false, false, false, true, false, false)
end
