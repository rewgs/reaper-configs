...
-- Main ----------------------------------------------------------------------------------------------------------------
function Main ()
	visTools.ShowTracksHideOthers("Track Visibility - Show only selected tracks and tracks with items in time selection", true, true, true, false, false, true, false, false, false)
end
