...
-- Main ----------------------------------------------------------------------------------------------------------------
function Main ()
	visTools.ShowTracksHideOthers("Track Visibility - Show only selected tracks and tracks with selected items", true, true, true, false, true, false, false, false, false)
end
