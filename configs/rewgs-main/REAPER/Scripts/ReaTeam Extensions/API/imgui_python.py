# Generated for ReaImGui v0.8.7.4
...
def ImGui_Selectable(ctx, label, p_selectedInOut, flagsInOptional = None, size_wInOptional = None, size_hInOptional = None):
  ...
  args = (c_void_p(ctx), rpr_packsc(label), c_bool(p_selectedInOut), c_int(flagsInOptional) if flagsInOptional != None else None, c_double(size_wInOptional) if size_wInOptional != None else None, c_double(size_hInOptional) if size_hInOptional != None else None)
...
def ImGui_DrawList_AddImageQuad(draw_list, img, p1_x, p1_y, p2_x, p2_y, p3_x, p3_y, p4_x, p4_y, uv1_xInOptional = None, uv1_yInOptional = None, uv2_xInOptional = None, uv2_yInOptional = None, uv3_xInOptional = None, uv3_yInOptional = None, uv4_xInOptional = None, uv4_yInOptional = None, col_rgbaInOptional = None):
  ...
  args = (c_void_p(draw_list), c_void_p(img), c_double(p1_x), c_double(p1_y), c_double(p2_x), c_double(p2_y), c_double(p3_x), c_double(p3_y), c_double(p4_x), c_double(p4_y), c_double(uv1_xInOptional) if uv1_xInOptional != None else None, c_double(uv1_yInOptional) if uv1_yInOptional != None else None, c_double(uv2_xInOptional) if uv2_xInOptional != None else None, c_double(uv2_yInOptional) if uv2_yInOptional != None else None, c_double(uv3_xInOptional) if uv3_xInOptional != None else None, c_double(uv3_yInOptional) if uv3_yInOptional != None else None, c_double(uv4_xInOptional) if uv4_xInOptional != None else None, c_double(uv4_yInOptional) if uv4_yInOptional != None else None, c_int(col_rgbaInOptional) if col_rgbaInOptional != None else None)
...
def ImGui_DrawList_AddImageRounded(draw_list, img, p_min_x, p_min_y, p_max_x, p_max_y, uv_min_x, uv_min_y, uv_max_x, uv_max_y, col_rgba, rounding, flagsInOptional = None):
  ...
  args = (c_void_p(draw_list), c_void_p(img), c_double(p_min_x), c_double(p_min_y), c_double(p_max_x), c_double(p_max_y), c_double(uv_min_x), c_double(uv_min_y), c_double(uv_max_x), c_double(uv_max_y), c_int(col_rgba), c_double(rounding), c_int(flagsInOptional) if flagsInOptional != None else None)
...
def ImGui_Image_GetSize(img):
  ...
  args = (c_void_p(img), c_double(0), c_double(0))
...
def ImGui_ImageSet_Add(set, scale, img):
  ...
  args = (c_void_p(set), c_double(scale), c_void_p(img))
...
def ImGui_ListClipper_IncludeRangeByIndices(clipper, item_begin, item_end):
  if not hasattr(ImGui_ListClipper_IncludeRangeByIndices, 'func'):
    proc = rpr_getfp('ImGui_ListClipper_IncludeRangeByIndices')
    ImGui_ListClipper_IncludeRangeByIndices.func = CFUNCTYPE(None, c_void_p, c_int, c_int)(proc)
  args = (c_void_p(clipper), c_int(item_begin), c_int(item_end))
  ImGui_ListClipper_IncludeRangeByIndices.func(args[0], args[1], args[2])
...
def ImGui_GetColorEx(ctx, col_rgba):
  ...
  args = (c_void_p(ctx), c_int(col_rgba))
...
def ImGui_BeginTable(ctx, str_id, column, flagsInOptional = None, outer_size_wInOptional = None, outer_size_hInOptional = None, inner_widthInOptional = None):
  ...
  args = (c_void_p(ctx), rpr_packsc(str_id), c_int(column), c_int(flagsInOptional) if flagsInOptional != None else None, c_double(outer_size_wInOptional) if outer_size_wInOptional != None else None, c_double(outer_size_hInOptional) if outer_size_hInOptional != None else None, c_double(inner_widthInOptional) if inner_widthInOptional != None else None)
...
def ImGui_TableGetColumnSortSpecs(ctx, id):
  ...
  args = (c_void_p(ctx), c_int(id), c_int(0), c_int(0), c_int(0), c_int(0))
...
def ImGui_CollapsingHeader(ctx, label, p_visibleInOut, flagsInOptional = None):
  ...
  args = (c_void_p(ctx), rpr_packsc(label), c_bool(p_visibleInOut), c_int(flagsInOptional) if flagsInOptional != None else None)
...
def ImGui_BeginChild(ctx, str_id, size_wInOptional = None, size_hInOptional = None, borderInOptional = None, flagsInOptional = None):
  ...
  args = (c_void_p(ctx), rpr_packsc(str_id), c_double(size_wInOptional) if size_wInOptional != None else None, c_double(size_hInOptional) if size_hInOptional != None else None, c_bool(borderInOptional) if borderInOptional != None else None, c_int(flagsInOptional) if flagsInOptional != None else None)
...
def ImGui_SetNextWindowSizeConstraints(ctx, size_min_w, size_min_h, size_max_w, size_max_h, custom_callbackInOptional = None):
